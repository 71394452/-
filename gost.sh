...
function pre_install(){
	...
	if [ "$xzy" == "2" ];then
	    xzy="https://raw.githubusercontent.com/71394452/sspan/master/gost_2.3_linux_amd64.tar.gz"
    else
	    xzy="hhttps://raw.githubusercontent.com/71394452/sspan/master/gost_2.3_linux_amd64.tar.gz"
	fi
